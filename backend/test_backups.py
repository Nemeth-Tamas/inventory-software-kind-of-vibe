...
def test_sanitize_and_validate_backup_filename():
    ...
    # Valid filenames
    assert sanitize_and_validate_backup_filename(
        "inventory_2026-07-13_020000.dump"
    ).endswith("inventory_2026-07-13_020000.dump")
    assert sanitize_and_validate_backup_filename(
        "safety_inventory_2026-07-13_120000.dump"
    ).endswith("safety_inventory_2026-07-13_120000.dump")
    ...
    with pytest.raises(ValueError):
        sanitize_and_validate_backup_filename(
            "/absolute/path/inventory_2026-07-13_020000.dump"
        )
    with pytest.raises(ValueError):
